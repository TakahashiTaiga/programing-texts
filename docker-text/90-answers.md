...
この演習が確かめているのは、知識の量ではなく、**「戻る場所を自分で言えるか」**です。
8.1.1 の表は、35 項目それぞれに**章番号**が付いています。
`✗` が付いた項目は「できないこと」ではなく、**「どこへ戻ればよいかが分かっている項目」**です。

以下では、**つまずきやすい判断**と、**打ち直しの進め方**を示します。
